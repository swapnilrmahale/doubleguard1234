...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>DoubleGuard Detecting Intrusions in Multitier Web Applications</title>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page">
                            ...
                            <form name="" action="NewUser" method="post">
                                <table>
                                    ...
                                    <%
                                        ...
                                        String sql = "select * from profile where userid='" + session.getAttribute("userid") + "'";
                                    ...
                                    <tr><td><h3>Blog</h3></td></tr>
                                    <tr><td><b>Welcome &nbsp;&nbsp;<%=request.getSession().getAttribute("userid")%>,</b></td></tr>

                                    <tr><td><img src="images/<%=logo%>" alt="" width="112" height="112" /></td>
                                    </tr>
                                </table>
                            </form>
                            <h2>Search Image Here</h2>
                            <form action="searchImage.jsp" method="post">
                                Search:&nbsp;&nbsp <input type="text" id="tag" name="tag"/> 
                                <br/><br/><br/>      <input type="submit" value="Search" style="background-color: #F78117;height: 35px;width: 90px;">
                            </form>                                                        
                        </div>
                ...
                <div id="sidebar">
                    <%
                        sql = "select * from user where user='" + session.getAttribute("userid") + "'";
                        pstm = con.prepareStatement(sql);
                    ...
                    <ul>
                        ...
                        <a name="contact">
                    <div id="flip"><a href="#contact">Click Here to Contact Us:</a></div>
                    <div id="panel">
