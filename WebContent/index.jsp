					...
					<div class="entry">
						<%
							if (request.getParameter("msg") != null) {
								...
								out.println("<span id='err'>" + request.getParameter("msg")
										+ "</span>");
								out.print("<img src='icons/exclamation.png'></img>");
							}
						%>
						<h2>
							Login <img src="icons/building_key.png" height="20" width="20"></img>
						</h2>
							...
							<table width="100%">
								...
								<tr>
									...
									<td><input type="submit" value="Login"
										style="background-color: #F78117; height: 30px; width: 90px;" /></td>
								</tr>
								<tr>
									<td>Enable SQL Guard</td>
									<td><input type="checkbox" name="enableSQLGuard"
